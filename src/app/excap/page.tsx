...
import CollapsibleCategory from "@/components/category";
    ...
    return (
        <div>
            ...
            <div className="m-8 p-4 bg-slate-700 rounded-xl">
                <CollapsibleCategory identifier="Provider Conditionals" styles="text-5xl select-none cursor-pointer font-semibold">
                    <div>
                        <Code methodName="ProviderConditional">{eng.Code.ProviderConditional}</Code>
                        <p className="text-xl indent-8">{eng.Text.TutorialConditional}</p>
                        <CollapsibleCategory identifier={eng.Headings.ConditionalMethods} styles="text-4xl flex m-4 font-semibold select-none cursor-pointer">
                        ...
                        <CollapsibleCategory identifier="Provider Conditional Types" styles="text-4xl flex m-4 font-semibold select-none cursor-pointer">
                        ...
                        <CollapsibleCategory identifier="Example" styles="text-4xl flex m-4 font-semibold select-none cursor-pointer">
                            <code className={excapModule.code}>
                                {eng.Examples.ProviderExample}
                            </code>
                        </CollapsibleCategory>
                    </div>
                </CollapsibleCategory>
